...
img_file2 = Image.open("stair.jpg")
img_resize2 = img_file2.resize((200,40))
img2  = ImageTk.PhotoImage(img_resize2)
canvas.create_image(300,500, image = img2, tag = "PLATFORM")

img_file3 = Image.open("stair.jpg")
img_resize3 = img_file3.resize((200,40))
img3  = ImageTk.PhotoImage(img_resize3)
canvas.create_image(1200,400, image = img3, tag = "PLATFORM")

img_file4 = Image.open("stair.jpg")
img_resize4 = img_file4.resize((200,40))
img4  = ImageTk.PhotoImage(img_resize4)
canvas.create_image(1000,300, image = img4, tag = "PLATFORM")

img_file5 = Image.open("stair.jpg")
img_resize5 = img_file5.resize((200,40))
img5  = ImageTk.PhotoImage(img_resize5)
canvas.create_image(500,300, image = img5, tag = "PLATFORM")

img_file6 = Image.open("stair.jpg")
img_resize6 = img_file6.resize((200,40))
img6  = ImageTk.PhotoImage(img_resize6)
canvas.create_image(700,600, image = img6, tag = "PLATFORM")

img_file7 = Image.open("stair.jpg")
img_resize7 = img_file7.resize((200,40))
img7  = ImageTk.PhotoImage(img_resize7)
canvas.create_image(800,400, image = img7, tag = "PLATFORM")
